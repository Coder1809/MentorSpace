            ...
            cart.map((item) => (
              ...
              >
                <div className="flex flex-col gap-2 text-sm">
                  <div className="flex items-center gap-2 text-base font-extrabold text-[#1F2937]">
                    <BadgeInfo className="w-4 h-4 text-[#4CAF7D] shrink-0" />
                    <span>{item.name}</span>
                  </div>
                  <div className="flex items-center gap-2 text-[#2e7d52] font-extrabold text-sm">
                    <IndianRupee className="w-4 h-4" />
                    <span>{item.price} (Full Track Fee)</span>
                  </div>
                  <div className="flex items-center gap-2 text-gray-600 font-bold text-xs">
                    <Clock className="w-4 h-4 text-[#4CAF7D] shrink-0" />
                    <span>
                      {item.durationWeeks
                        ? `${item.durationWeeks} Weeks (${item.totalSessions || 12} Live 1-on-1 Sessions)`
                ...
                <Button
                  ...
                  className="text-red-500 border border-red-200 hover:bg-red-50 hover:text-red-600 transition-all rounded-lg shrink-0"
                >
                  <X className="w-4 h-4" />
                </Button>
              </div>
